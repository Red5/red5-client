...
public class RTMPTSClientTest extends RTMPTSClient {
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        final RTMPTSClientTest player = new RTMPTSClientTest();
    ...
    public void connect() {
        ...
        connect(PropertiesReader.getProperty("rtmpts.server"), Integer.valueOf(PropertiesReader.getProperty("rtmpts.port")), PropertiesReader.getProperty("rtmpts.app"), connectCallback);
    }
